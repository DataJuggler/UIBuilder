        ...
        #region Static Methods
            ...
            public static Method Load(DataRow dataRow)
            {
                ...
                try
                {
                    ...
                    method.MethodType = DataHelper.ParseInteger(dataRow.ItemArray[methodTypefield], 0);
                    ...
                    method.OrderByType = DataHelper.ParseInteger(dataRow.ItemArray[orderByTypefield], 0);
                    ...
                    method.ParameterType = DataHelper.ParseInteger(dataRow.ItemArray[parameterTypefield], 0);
