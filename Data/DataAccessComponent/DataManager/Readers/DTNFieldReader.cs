    ...
    public class DTNFieldReader
    {
        ...
        #region Static Methods
            ...
            public static DTNField Load(DataRow dataRow)
            {
                ...
                {
                    // Load Each field
                    dTNField.AccessMode = DataHelper.ParseInteger(dataRow.ItemArray[accessModefield], 0);
                    ...
                    dTNField.DataType = DataHelper.ParseInteger(dataRow.ItemArray[dataTypefield], 0);
                    ...
                    dTNField.Scope = DataHelper.ParseInteger(dataRow.ItemArray[scopefield], 0);
