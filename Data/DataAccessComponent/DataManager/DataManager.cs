...
namespace DataAccessComponent.DataManager
{
    ...
    public class DataManager
    {
        ...
        private UIControlDetailManager uicontroldetailManager;
        private UIControlTemplateManager uicontroltemplateManager;
        private UIFieldManager uifieldManager;
        private UIObjectManager uiobjectManager;
        private UIProjectManager uiprojectManager;
        ...
        #region Methods
            ...
            private void Init()
            {
                ...
                this.UIControlDetailManager = new UIControlDetailManager(this);
                this.UIControlTemplateManager = new UIControlTemplateManager(this);
                this.UIFieldManager = new UIFieldManager(this);
                this.UIObjectManager = new UIObjectManager(this);
                this.UIProjectManager = new UIProjectManager(this);
        ...
        #region Properties
            ...
            #region UIControlDetailManager
            public UIControlDetailManager UIControlDetailManager
            {
                get { return uicontroldetailManager; }
                set { uicontroldetailManager = value; }
            }
            #endregion

            #region UIControlTemplateManager
            public UIControlTemplateManager UIControlTemplateManager
            {
                get { return uicontroltemplateManager; }
                set { uicontroltemplateManager = value; }
            }
            #endregion
            ...
            #region UIProjectManager
            public UIProjectManager UIProjectManager
            {
                get { return uiprojectManager; }
                set { uiprojectManager = value; }
            }
            #endregion
