...
namespace DataAccessComponent.DataManager
{
    ...
    public class EnumerationManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public bool DeleteEnumeration(DeleteEnumerationStoredProcedure deleteEnumerationProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = this.DataHelper.DeleteRecord(deleteEnumerationProc, databaseConnector);
                }
            ...
            /// </summary>
            public List<Enumeration> FetchAllEnumerations(FetchAllEnumerationsStoredProcedure fetchAllEnumerationsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allEnumerationsDataSet = this.DataHelper.LoadDataSet(fetchAllEnumerationsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allEnumerationsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = this.DataHelper.ReturnFirstTable(allEnumerationsDataSet);
            ...
            /// </summary>
            public int InsertEnumeration(InsertEnumerationStoredProcedure insertEnumerationProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = this.DataHelper.InsertRecord(insertEnumerationProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public bool UpdateEnumeration(UpdateEnumerationStoredProcedure updateEnumerationProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = this.DataHelper.UpdateRecord(updateEnumerationProc, databaseConnector);
                }
