...
namespace DataAccessComponent.DataManager
{
    ...
    public class MethodManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public bool DeleteMethod(DeleteMethodStoredProcedure deleteMethodProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = this.DataHelper.DeleteRecord(deleteMethodProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public bool UpdateMethod(UpdateMethodStoredProcedure updateMethodProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = this.DataHelper.UpdateRecord(updateMethodProc, databaseConnector);
                }
